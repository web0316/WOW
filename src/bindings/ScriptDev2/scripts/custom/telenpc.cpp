...
{
        player->ADD_GOSSIP_ITEM( 1, " 【世界竞技中心】",            1, GOSSIP_ACTION_INFO_DEF + 12);
        player->ADD_GOSSIP_ITEM( 1, " 【世界主城传送】",            1, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM( 1, " 【燃烧远征传送】",            1, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM( 1, " 【巫妖王传送点】",            1, GOSSIP_ACTION_INFO_DEF + 10);
        player->ADD_GOSSIP_ITEM( 1, " 【初级副本传送】",            1, GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM( 1, " 【中级副本传送】",            1, GOSSIP_ACTION_INFO_DEF + 4);
        player->ADD_GOSSIP_ITEM( 1, " 【团队副本传送】",            1, GOSSIP_ACTION_INFO_DEF + 5);
        player->ADD_GOSSIP_ITEM( 1, " 【外域五人副本】",            1, GOSSIP_ACTION_INFO_DEF + 6);
        player->ADD_GOSSIP_ITEM( 1, " 【外域团队副本】",            1, GOSSIP_ACTION_INFO_DEF + 7);
        player->ADD_GOSSIP_ITEM( 1, " 【北极副本传送】",            1, GOSSIP_ACTION_INFO_DEF + 11);
        player->ADD_GOSSIP_ITEM( 1, " 【世界战场传送】",            1, GOSSIP_ACTION_INFO_DEF + 8);
        player->ADD_GOSSIP_ITEM( 1, " 【附加特殊功能】",            1, GOSSIP_ACTION_INFO_DEF + 9);
...
void SendDefaultMenu_npc_teleport(Player *player, Creature *_Creature, uint32 action)
{
        ...
        case GOSSIP_ACTION_INFO_DEF + 1 :
                ...
                {
                        player->ADD_GOSSIP_ITEM( 2, " 攻打 奥格瑞玛", 2, GOSSIP_ACTION_INFO_DEF + 5);
                        player->ADD_GOSSIP_ITEM( 2, " 联盟 暴风城",   2, GOSSIP_ACTION_INFO_DEF + 1);
                        player->ADD_GOSSIP_ITEM( 2, " 联盟 铁炉堡",   2, GOSSIP_ACTION_INFO_DEF + 2);
                        player->ADD_GOSSIP_ITEM( 2, " 联盟 达纳苏斯", 2, GOSSIP_ACTION_INFO_DEF + 3);
                        player->ADD_GOSSIP_ITEM( 2, " 联盟 艾克索达", 2, GOSSIP_ACTION_INFO_DEF + 4);
                } else {             // 部落
                        player->ADD_GOSSIP_ITEM( 2, " 攻打 暴风城",   2, GOSSIP_ACTION_INFO_DEF + 1);
                        player->ADD_GOSSIP_ITEM( 2, " 部落 奥格瑞玛", 2, GOSSIP_ACTION_INFO_DEF + 5);
                        player->ADD_GOSSIP_ITEM( 2, " 部落 雷霆崖",   2, GOSSIP_ACTION_INFO_DEF + 6);
                        player->ADD_GOSSIP_ITEM( 2, " 部落 幽暗城",   2, GOSSIP_ACTION_INFO_DEF + 7);
                        player->ADD_GOSSIP_ITEM( 2, " 部落 银月城",   2, GOSSIP_ACTION_INFO_DEF + 8);
                }
                player->ADD_GOSSIP_ITEM( 2, " 中立 棘齿城",       2, GOSSIP_ACTION_INFO_DEF + 9);
                player->ADD_GOSSIP_ITEM( 2, " 中立 藏宝海湾",     2, GOSSIP_ACTION_INFO_DEF + 10);
                player->ADD_GOSSIP_ITEM( 2, " 中立 冬泉谷",       2, GOSSIP_ACTION_INFO_DEF + 11);
                player->ADD_GOSSIP_ITEM( 2, " 中立 加基森",       2, GOSSIP_ACTION_INFO_DEF + 12);
        ...
        case GOSSIP_ACTION_INFO_DEF + 2 :
                ...
                player->ADD_GOSSIP_ITEM( 2, " 黑暗之门",            3, GOSSIP_ACTION_INFO_DEF + 1);
                player->ADD_GOSSIP_ITEM( 2, " 沙塔斯城",            3, GOSSIP_ACTION_INFO_DEF + 6);
                player->ADD_GOSSIP_ITEM( 2, " 永歌森林",            3, GOSSIP_ACTION_INFO_DEF + 2);
                player->ADD_GOSSIP_ITEM( 2, " 海加尔峰",            3, GOSSIP_ACTION_INFO_DEF + 3);
                player->ADD_GOSSIP_ITEM( 2, " 青草平原",            3, GOSSIP_ACTION_INFO_DEF + 4);
                player->ADD_GOSSIP_ITEM( 2, " 翠叶森林",            3, GOSSIP_ACTION_INFO_DEF + 5);
                player->ADD_GOSSIP_ITEM( 2, " 哈兰",                3, GOSSIP_ACTION_INFO_DEF + 7);
                player->ADD_GOSSIP_ITEM( 2, " 风暴尖塔",            3, GOSSIP_ACTION_INFO_DEF + 8);
        ...
        case GOSSIP_ACTION_INFO_DEF + 3 :
                player->ADD_GOSSIP_ITEM( 2, " 怒焰裂谷",     4, GOSSIP_ACTION_INFO_DEF + 1);
                player->ADD_GOSSIP_ITEM( 2, " 死亡矿井",     4, GOSSIP_ACTION_INFO_DEF + 2);
                player->ADD_GOSSIP_ITEM( 2, " 哀嚎洞穴",     4, GOSSIP_ACTION_INFO_DEF + 3);
                player->ADD_GOSSIP_ITEM( 2, " 影牙城堡",     4, GOSSIP_ACTION_INFO_DEF + 4);
                player->ADD_GOSSIP_ITEM( 2, " 黑暗深渊",     4, GOSSIP_ACTION_INFO_DEF + 5);
                player->ADD_GOSSIP_ITEM( 2, " 暴风城监狱",   4, GOSSIP_ACTION_INFO_DEF + 6);
                player->ADD_GOSSIP_ITEM( 2, " 剃刀沼泽",     4, GOSSIP_ACTION_INFO_DEF + 7);
                player->ADD_GOSSIP_ITEM( 2, " 诺莫瑞根",     4, GOSSIP_ACTION_INFO_DEF + 8);
                player->ADD_GOSSIP_ITEM( 2, " 血色修道院",   4, GOSSIP_ACTION_INFO_DEF + 9);
                player->ADD_GOSSIP_ITEM( 2, " 剃刀高地",     4, GOSSIP_ACTION_INFO_DEF + 10);
                player->ADD_GOSSIP_ITEM( 2, " 奥达曼",       4, GOSSIP_ACTION_INFO_DEF + 11);
        ...
        case GOSSIP_ACTION_INFO_DEF + 4 :
                player->ADD_GOSSIP_ITEM( 2, " 祖尔法拉克",       5, GOSSIP_ACTION_INFO_DEF + 1);
                player->ADD_GOSSIP_ITEM( 2, " 马拉顿",           5, GOSSIP_ACTION_INFO_DEF + 2);
                player->ADD_GOSSIP_ITEM( 2, " 失落的神庙",       5, GOSSIP_ACTION_INFO_DEF + 3);
                player->ADD_GOSSIP_ITEM( 2, " 黑石深渊",         5, GOSSIP_ACTION_INFO_DEF + 4);
                player->ADD_GOSSIP_ITEM( 2, " 通灵学院",         5, GOSSIP_ACTION_INFO_DEF + 5);
                player->ADD_GOSSIP_ITEM( 2, " 厄运[北区]",     5, GOSSIP_ACTION_INFO_DEF + 6);
                player->ADD_GOSSIP_ITEM( 2, " 厄运[东区]",     5, GOSSIP_ACTION_INFO_DEF + 7);
                player->ADD_GOSSIP_ITEM( 2, " 厄运[西区]",     5, GOSSIP_ACTION_INFO_DEF + 8);
                player->ADD_GOSSIP_ITEM( 2, " 斯坦索姆",         5, GOSSIP_ACTION_INFO_DEF + 9);
                player->ADD_GOSSIP_ITEM( 2, " 黑石塔下",           5, GOSSIP_ACTION_INFO_DEF + 10);
        ...
        case GOSSIP_ACTION_INFO_DEF + 5 :
                player->ADD_GOSSIP_ITEM( 2, " 溶火之心",         6, GOSSIP_ACTION_INFO_DEF + 1);
                player->ADD_GOSSIP_ITEM( 2, " 黑石塔",           6, GOSSIP_ACTION_INFO_DEF + 2);
                player->ADD_GOSSIP_ITEM( 2, " 祖尔格拉布",       6, GOSSIP_ACTION_INFO_DEF + 3);
                player->ADD_GOSSIP_ITEM( 2, " 黑翼之巢",         6, GOSSIP_ACTION_INFO_DEF + 4);
                player->ADD_GOSSIP_ITEM( 2, " 安其拉神庙",       6, GOSSIP_ACTION_INFO_DEF + 5);
                player->ADD_GOSSIP_ITEM( 2, " 安其拉废墟",       6, GOSSIP_ACTION_INFO_DEF + 6);
                player->ADD_GOSSIP_ITEM( 2, " 奥妮克希亚的巢穴", 6, GOSSIP_ACTION_INFO_DEF + 7);
                player->ADD_GOSSIP_ITEM( 2, " 纳克萨玛斯",       6, GOSSIP_ACTION_INFO_DEF + 8);
                player->ADD_GOSSIP_ITEM( 2, " 冰龙巢穴",         6, GOSSIP_ACTION_INFO_DEF + 9);
                player->ADD_GOSSIP_ITEM( 2, " 祖阿曼",           6, GOSSIP_ACTION_INFO_DEF + 10);
        ...
        case GOSSIP_ACTION_INFO_DEF + 6 :
                player->ADD_GOSSIP_ITEM( 2, " 暴风城超级监狱", 7, GOSSIP_ACTION_INFO_DEF + 1);
                player->ADD_GOSSIP_ITEM( 2, " 卡拉赞",         7, GOSSIP_ACTION_INFO_DEF + 2);
                player->ADD_GOSSIP_ITEM( 2, " 遗忘之井",        7, GOSSIP_ACTION_INFO_DEF + 3);
                player->ADD_GOSSIP_ITEM( 2, " 鬼魂之地",       7, GOSSIP_ACTION_INFO_DEF + 4);
                player->ADD_GOSSIP_ITEM( 2, " 地狱火城墙",     7, GOSSIP_ACTION_INFO_DEF + 5);
                player->ADD_GOSSIP_ITEM( 2, " 风暴要塞",       7, GOSSIP_ACTION_INFO_DEF + 6);
                player->ADD_GOSSIP_ITEM( 2, " 暗影迷宫",         7, GOSSIP_ACTION_INFO_DEF + 7);
                player->ADD_GOSSIP_ITEM( 2, " 黑暗神殿",       7, GOSSIP_ACTION_INFO_DEF + 8);
                player->ADD_GOSSIP_ITEM( 2, " 赞格沼泽",       7, GOSSIP_ACTION_INFO_DEF + 9);
                player->ADD_GOSSIP_ITEM( 2, " 黑色沼泽",       7, GOSSIP_ACTION_INFO_DEF + 10);
                player->ADD_GOSSIP_ITEM( 2, " 毒蛇神殿",       7, GOSSIP_ACTION_INFO_DEF + 11);
        ...
        case GOSSIP_ACTION_INFO_DEF + 7 :
                player->ADD_GOSSIP_ITEM( 2, " 破碎大厅",       8, GOSSIP_ACTION_INFO_DEF + 1);
                player->ADD_GOSSIP_ITEM( 2, " 鲜血熔炉",         8, GOSSIP_ACTION_INFO_DEF + 2);
                player->ADD_GOSSIP_ITEM( 2, " 生态船",       8, GOSSIP_ACTION_INFO_DEF + 3);
                player->ADD_GOSSIP_ITEM( 2, " 禁魔监狱",       8, GOSSIP_ACTION_INFO_DEF + 4);
                player->ADD_GOSSIP_ITEM( 2, " 能源舰",       8, GOSSIP_ACTION_INFO_DEF + 5);
                player->ADD_GOSSIP_ITEM( 2, " 凤凰大厅",       8, GOSSIP_ACTION_INFO_DEF + 6);
                player->ADD_GOSSIP_ITEM( 2, " 奴隶围栏",       8, GOSSIP_ACTION_INFO_DEF + 7);
                player->ADD_GOSSIP_ITEM( 2, " 蒸汽地窟",       8, GOSSIP_ACTION_INFO_DEF + 8);
                player->ADD_GOSSIP_ITEM( 2, " 幽暗沼泽",       8, GOSSIP_ACTION_INFO_DEF + 9);
                player->ADD_GOSSIP_ITEM( 2, " 格鲁尔的巢穴",   8, GOSSIP_ACTION_INFO_DEF + 10);
                player->ADD_GOSSIP_ITEM( 2, " 玛瑟里顿的巢穴", 8, GOSSIP_ACTION_INFO_DEF + 11);
                player->ADD_GOSSIP_ITEM( 2, " 太阳之井高地",   8, GOSSIP_ACTION_INFO_DEF + 12);
                player->ADD_GOSSIP_ITEM( 0, " 魔导师平台",       8, GOSSIP_ACTION_INFO_DEF + 13);
        ...
        case GOSSIP_ACTION_INFO_DEF + 8 :
                player->ADD_GOSSIP_ITEM( 2, " 奥特兰战场",     9, GOSSIP_ACTION_INFO_DEF + 2);
                player->ADD_GOSSIP_ITEM( 2, " 战歌峡谷",       9, GOSSIP_ACTION_INFO_DEF + 3);
                player->ADD_GOSSIP_ITEM( 2, " 阿拉希战场",     9, GOSSIP_ACTION_INFO_DEF + 4);
        ...
        case GOSSIP_ACTION_INFO_DEF + 9 :
                player->ADD_GOSSIP_ITEM( 1, " 版本说明",       10, GOSSIP_ACTION_INFO_DEF + 1);
                player->ADD_GOSSIP_ITEM( 1, " 个人银行",       10, GOSSIP_ACTION_INFO_DEF + 2);
                player->ADD_GOSSIP_ITEM( 1, " 装备修复",       10, GOSSIP_ACTION_INFO_DEF + 3);
                player->ADD_GOSSIP_ITEM( 1, " 开飞行点",       10, GOSSIP_ACTION_INFO_DEF + 4);
                player->ADD_GOSSIP_ITEM( 1, " 地图全开",       10, GOSSIP_ACTION_INFO_DEF + 5);

                player->ADD_GOSSIP_ITEM( 7, " 返回上一级菜单", 10, GOSSIP_ACTION_INFO_DEF + 99);
                player->SEND_GOSSIP_MENU(999999,_Creature->GetGUID());
                break;
        case GOSSIP_ACTION_INFO_DEF + 10 :
        player->ADD_GOSSIP_ITEM( 2, " 黑暗堡[DK出生地]",       11, GOSSIP_ACTION_INFO_DEF + 8);
                player->ADD_GOSSIP_ITEM( 2, " 肖拉查盆地",       11, GOSSIP_ACTION_INFO_DEF + 3);
                player->ADD_GOSSIP_ITEM( 2, " 北风苔原",       11, GOSSIP_ACTION_INFO_DEF + 4);
                player->ADD_GOSSIP_ITEM( 2, " 龙骨荒野",       11, GOSSIP_ACTION_INFO_DEF + 5);
                player->ADD_GOSSIP_ITEM( 2, " 祖尔德拉克",       11, GOSSIP_ACTION_INFO_DEF + 6);
                player->ADD_GOSSIP_ITEM( 2, " 暴风之颠",       11, GOSSIP_ACTION_INFO_DEF + 7);
                player->ADD_GOSSIP_ITEM( 2, " 寒冰皇冠",       11, GOSSIP_ACTION_INFO_DEF + 1);
                player->ADD_GOSSIP_ITEM( 2, " 尖啸海岸",       11, GOSSIP_ACTION_INFO_DEF + 2);

                player->ADD_GOSSIP_ITEM( 7, " |cff8000FF返回上一级菜单|CFF009933 ", 11, GOSSIP_ACTION_INFO_DEF + 99);
                player->SEND_GOSSIP_MENU(999999,_Creature->GetGUID());
                break;
        case GOSSIP_ACTION_INFO_DEF + 11 :
                player->ADD_GOSSIP_ITEM( 2, " 北极副本",       12, GOSSIP_ACTION_INFO_DEF + 1);
                player->ADD_GOSSIP_ITEM( 2, " 蓝龙巢穴",       12, GOSSIP_ACTION_INFO_DEF + 2);
